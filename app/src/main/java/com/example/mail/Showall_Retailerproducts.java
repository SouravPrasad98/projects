...
public class Showall_Retailerproducts extends AppCompatActivity {
    private AdapterProductRetailer adapterProductRetailer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showall__retailerproducts);
        ...
        searchProductEt.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                try{
                    adapterProductRetailer.getFilter().filter(s);
                }
                catch (Exception e){
                    e.printStackTrace();
                }
        ...
        filterProductbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Showall_Retailerproducts.this);
        ...
        addproduct.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Showall_Retailerproducts.this,Retailer_addproduct.class));
        ...
        reference.child(firebaseAuth.getUid()).child("RetailerProducts")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        adapterProductRetailer = new AdapterProductRetailer(Showall_Retailerproducts.this, productList);
                        productsRv.setAdapter(adapterProductRetailer);
                    }
    ...
    private void checkuser(){
        ...
        if(user==null){
            startActivity(new Intent(Showall_Retailerproducts.this, Choice_Role.class));
            finish();
        }
        else
        {
    ...
    private void loadmyinfo() {
        ...
        ref.orderByChild("uid").equalTo(firebaseAuth.getUid())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(Showall_Retailerproducts.this, "error", Toast.LENGTH_SHORT).show();
