...
public class EditRetailerProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_retailer_product);
    ...
    private void loadProductDetails() {
        ...
        reference.child(firebaseAuth.getUid()).child("RetailerProducts").child(productId)
    ...
    private void updateproduct() {
        ...
        if (image_uri == null) {
            ...
            ref.child(firebaseAuth.getUid()).child("RetailerProducts").child(productId).updateChildren(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            progressDialog.dismiss();
                            Toast.makeText(EditRetailerProductActivity.this, "Product updated...", LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(EditRetailerProductActivity.this, "error", LENGTH_SHORT).show();
                        }
                    });
