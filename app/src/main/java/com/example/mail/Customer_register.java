...
public class Customer_register extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        retailerSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Customer_register.this, Retailer_register.class));
                return;
            }
        });
        ...
        wholeSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Customer_register.this, Wholeseller_register.class));
                return;
            }
        });
        ...
        super.onActivityResult(requestCode, resultCode, data);
            ...
            private void inputData() {
                ...
                if(!password.equals(confirmpssd)){
                    Toast.makeText(getApplicationContext(), "Password must be same as confirm password", LENGTH_SHORT).show();
                    return;
                }
                ...
                firebaseAuth.createUserWithEmailAndPassword(email, password)
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                Toast.makeText(Customer_register.this, "" + e.getMessage(), LENGTH_SHORT).show();
                            }
                        });
            }
                    ...
                    ref.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(hashMap)
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    progressDialog.dismiss();
                                    startActivity(new Intent(Customer_register.this, Customer_activity.class));
                                    finish();
                                }
                            })
                            .addOnFailureListener(new OnFailureListener() {
