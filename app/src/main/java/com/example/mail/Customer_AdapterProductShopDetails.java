...
public class Customer_AdapterProductShopDetails extends RecyclerView.Adapter<Customer_AdapterProductShopDetails.HolderProductRetailer> implements Filterable {
    public ArrayList<ModelProduct> productslist, filterlist;
    private Context context;
    private Customer_FilterProduct_Shopdetails filter;

    public Customer_AdapterProductShopDetails(Context context, ArrayList<ModelProduct>productslist){
    ...
    public Filter getFilter() {
        if (filter == null){
            filter = new Customer_FilterProduct_Shopdetails(this, filterlist);
        }
        return filter;
    }
