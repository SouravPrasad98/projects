...
public class AdapterbyCustomerOrderedItem extends RecyclerView.Adapter<AdapterbyCustomerOrderedItem.HolderOrderedItem> {
    private Context context;
    private ArrayList<ModelOrderedItem> orderedItemArrayList;

    public AdapterbyCustomerOrderedItem(Context context, ArrayList<ModelOrderedItem> orderedItemArrayList) {
