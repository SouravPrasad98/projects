...
//        loadAllProducts();
        ...
        filterProductbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Retailer_activity.this);
...
//                                    loadAllProducts();
        ...
        addproduct.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Retailer_activity.this,Retailer_addproduct.class));
...
//    }
    ...
    private void checkuser(){
        ...
        if(user==null){
            startActivity(new Intent(Retailer_activity.this, Choice_Role.class));
            finish();
        }
        else
        {
    ...
    private void loadmyinfo() {
        ...
        ref.orderByChild("uid").equalTo(firebaseAuth.getUid())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(Retailer_activity.this, "error", Toast.LENGTH_SHORT).show();
