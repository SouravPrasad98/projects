...
public class Customer_AdapterReview extends RecyclerView.Adapter<Customer_AdapterReview.HolderReview>{
    private Context context;
    private ArrayList<ModelReview> reviewArrayList;

    public Customer_AdapterReview(Context context, ArrayList<ModelReview> reviewArrayList) {
