...
public class Showall_products extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filterProductbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Showall_products.this);
        ...
        addproduct.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Showall_products.this,Wholeseller_addproduct.class));
        ...
        reference.child(firebaseAuth.getUid()).child("Products")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        adapterProductWholeseller = new AdapterProductWholeseller(Showall_products.this, productList);
    ...
    private void checkuser(){
        ...
        if(user==null){
            startActivity(new Intent(Showall_products.this, Choice_Role.class));
            finish();
        }
        else
        {
    ...
    private void loadmyinfo() {
        ...
        ref.orderByChild("uid").equalTo(firebaseAuth.getUid())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(Showall_products.this, "error", Toast.LENGTH_SHORT).show();
