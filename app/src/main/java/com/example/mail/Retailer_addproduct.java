...
public class Retailer_addproduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retailer_addproduct);
    ...
    private void addproduct() {
        ...
        if(image_uri== null){
            ...
            ref.child(firebaseAuth.getUid()).child("RetailerProducts").child(timestamp).setValue(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            progressDialog.dismiss();
                            Toast.makeText(Retailer_addproduct.this, "Product added...", LENGTH_SHORT).show();
                            clearData();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(Retailer_addproduct.this, "error", LENGTH_SHORT).show();
                        }
                    });
            DatabaseReference productRef = FirebaseDatabase.getInstance().getReference("RetailerProducts");
            productRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    productRef.child(product_name).child("RetailerList").child(Constants.wuid).setValue(wsd);
                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if(uriTask.isSuccessful()){
                                ...
                                hashMap1.put("uid",""+firebaseAuth.getUid());
                                DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Retailer");
                                ref.child(firebaseAuth.getUid()).child("RetailerProducts").child(timestamp).setValue(hashMap1)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            @Override
                                            public void onSuccess(Void aVoid) {
                                                progressDialog.dismiss();
        ...
        DatabaseReference productRef = FirebaseDatabase.getInstance().getReference("RetailerProduct");
        productRef.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(!snapshot.child(product_name).exists())
