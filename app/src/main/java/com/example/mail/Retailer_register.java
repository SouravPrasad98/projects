...
public class Retailer_register extends AppCompatActivity implements LocationListener {
    ...
    private EditText confirm_password, password1, delevid, wholid, emaillidddd, busstyyp, PhoneNumber,
            bussnm, younm;
    private TextView addlll, cityyid, stateid, countrid,UserSignUp,wholeSignUp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserSignUp.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Retailer_register.this,User_register.class));
                return;
            }
        });
                ...
                ref.child("wholesellerid").setValue(hashMap)
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                progressDialog.dismiss();
                                startActivity(new Intent(Retailer_register.this, Wholeseller_activity.class));
                                finish();
                            }
                        })
                        .addOnFailureListener(new OnFailureListener() {
