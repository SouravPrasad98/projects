...
public class Customer_AdapterOrderRetailer extends RecyclerView.Adapter<Customer_AdapterOrderRetailer.HolderOrderRetailer> {

    private Context context;
    private ArrayList<ModelOrderRetailer> orderUsersList;

    public Customer_AdapterOrderRetailer(Context context, ArrayList<ModelOrderRetailer> orderUsersList) {
    ...
    public void onBindViewHolder(@NonNull HolderOrderRetailer holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, Customer_OrderdetailsActivity.class);
