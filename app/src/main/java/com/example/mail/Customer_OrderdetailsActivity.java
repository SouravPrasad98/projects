...
public class Customer_OrderdetailsActivity extends AppCompatActivity {
        ...
        ref.child(orderId).child("Items")
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                       ...
                       adapterOrderedItem = new AdapterOrderedItem(Customer_OrderdetailsActivity.this, orderedItemArrayList);
