...
public class Customer_RetailerShopdetailsActivity extends AppCompatActivity {
...
//        loadmyinfo();
       ...
       reviewsBtn.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View v) {
              Intent intent = new Intent(Customer_RetailerShopdetailsActivity.this, Customer_ShopReviewsActivity.class);
        ...
        filterProductbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Customer_RetailerShopdetailsActivity.this);
    ...
    private void showCartDialog() {
        ...
        checkoutBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Customer_RetailerShopdetailsActivity.this,"Please enter your address in your profile before placing order...",Toast.LENGTH_LONG).show();
                    return;
                }
                if (myPhone.equals("")   || myPhone.equals("null"))
                {
                    Toast.makeText(Customer_RetailerShopdetailsActivity.this,"Please enter your Phone Number in your profile before placing order...",Toast.LENGTH_LONG).show();
                    return;
                }
                if(cartItemList.size() == 0)
                {
                    Toast.makeText(Customer_RetailerShopdetailsActivity.this,"Cart empty...",Toast.LENGTH_LONG).show();
                    return;
                }
                submitOrder();
            }
    ...
    private void loadFilteredProducts(String selected) {
        ...
        reference.child(uid).child("RetailerProducts")
                .addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        productList.clear();
    ...
    private void loadmyinfo() {
        ...
        ref.orderByChild("uid").equalTo(firebaseAuth.getUid())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(Customer_RetailerShopdetailsActivity.this, "error", Toast.LENGTH_SHORT).show();
