...
public class AdapterOrderCustomer2 extends RecyclerView.Adapter<AdapterOrderCustomer2.HolderOrderWholeseller>  {
    public ArrayList<ModelOrderWholeseller> modelOrderWholesellerArrayList;
    private Context context;



    public AdapterOrderCustomer2(Context context, ArrayList<ModelOrderWholeseller> modelOrderWholesellerArrayList) {
